  ...
  return (
    <div>
      ...
      <p style={{
        ...
        lineHeight: 1.55, margin: "32px 0 20px",
      }}>
        &ldquo;{t.quote}&rdquo;
      </p>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
        ...
        <div>
          ...
          <p style={{ fontFamily: FONT_BODY, fontSize: 14, fontWeight: 400, color: "rgba(11,13,17,0.75)", lineHeight: 1.55, letterSpacing: '-0.01em', margin: "3px 0 0" }}>
            {t.role}
          </p>
        </div>
      </div>
      ...
      {/* Arrow buttons */}
      <div className="r-testimonial-arrows" style={{ display: "flex", gap: 6 }}>
